...
class CollateralManager:
    ...
    def slash(
        ...
        self._execute_evm_contract_function(
    ...
    def burn(
        ...
        """
        Burn the specified amount of alpha tokens on Subtensor from the vault's stake.
        This function should be called on the owner validator side.
        ...
        Returns:
            Balance: The amount of alpha tokens burned.
    ...
    def slash_with_burn(
        ...
        try:
            ...
            # IMPORTANT: At this point, the EVM slash already succeeded.
